...
/*
const float THRESH_HEAT = 0.02;
const float THRESH_VECTOR_SCORE = 0;
const int THRESH_VECTOR_CNT1 = 1;
const int THRESH_PART_CNT = 10;
const float THRESH_HUMAN_SCORE = 1;
*/
